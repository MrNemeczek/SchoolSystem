...
namespace SchoolSystem.Controllers
{
    public class ClassesController : Controller
    {
        ...
        public ClassesController(school_systemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,IdTeacher")] Class @class)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,IdTeacher")] Class @class)
        {
            if (id != @class.Id)
            {
                return NotFound();
