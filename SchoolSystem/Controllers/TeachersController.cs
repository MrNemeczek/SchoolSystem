...
namespace SchoolSystem.Controllers
{
    public class TeachersController : Controller
    {
        ...
        public TeachersController(school_systemContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Lastname,Birthdate,AdmissionDate,Active")] Teacher teacher)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Lastname,Birthdate,AdmissionDate,Active")] Teacher teacher)
        {
            if (id != teacher.Id)
            {
                return NotFound();
